...
class UrlGenerator {
	...
	public function asset($path, $secure = null)
	{
		...
		// Once we get the root URL, we will check to see if it contains an index_bootstrap-TEMPLATE.php
	...
	/**
	 * Remove the index_bootstrap-TEMPLATE.php file from a path.
	 *
	 * @param  string  $root
	 * @return string
	 */
	...
	{
		$i = 'index_bootstrap-TEMPLATE.php';
