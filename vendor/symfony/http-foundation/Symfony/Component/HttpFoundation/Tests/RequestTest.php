...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetUri()
    {
        ...
        // http://host:8080/index_bootstrap-TEMPLATE.php/path/info?query=string
        ...
        $server['REQUEST_URI'] = '/index_bootstrap-TEMPLATE.php/path/info?query=string';
        $server['SCRIPT_NAME'] = '/index_bootstrap-TEMPLATE.php';
        $server['PATH_INFO'] = '/path/info';
        $server['PATH_TRANSLATED'] = 'redirect:/index_bootstrap-TEMPLATE.php/path/info';
        $server['PHP_SELF'] = '/index_dev.php/path/info';
        $server['SCRIPT_FILENAME'] = '/some/where/index_bootstrap-TEMPLATE.php';

        $request = new Request();

        $request->initialize(array(), array(), array(), array(), array(), $server);

        $this->assertEquals('http://host:8080/index_bootstrap-TEMPLATE.php/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $this->assertEquals('http://host/index_bootstrap-TEMPLATE.php/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('http://servername/index_bootstrap-TEMPLATE.php/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide index_bootstrap-TEMPLATE.php)
        //   RewriteCond %{REQUEST_FILENAME} !-f
        //   RewriteRule ^(.*)$ index_bootstrap-TEMPLATE.php [QSA,L]
        ...
        $server['SCRIPT_NAME'] = '/index_bootstrap-TEMPLATE.php';
        $server['PHP_SELF'] = '/index_bootstrap-TEMPLATE.php';
        $server['SCRIPT_FILENAME'] = '/some/where/index_bootstrap-TEMPLATE.php';
        ...
        $server = array(
            ...
            'PATH_TRANSLATED' => 'redirect:/index_bootstrap-TEMPLATE.php/foo bar/in+fo',
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/index_bootstrap-TEMPLATE.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('http://host/index_bootstrap-TEMPLATE.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('http://servername/index_bootstrap-TEMPLATE.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
    ...
    public function testGetScriptName()
    {
        ...
        $this->assertEquals('/index_bootstrap-TEMPLATE.php', $request->getScriptName());
    ...
    public function testGetBasePath()
    {
        ...
        $server = array();
        $server['SCRIPT_FILENAME'] = '/some/where/index_bootstrap-TEMPLATE.php';
        $server['ORIG_SCRIPT_NAME'] = '/index_bootstrap-TEMPLATE.php';
        $request->initialize(array(), array(), array(), array(), array(), $server);
