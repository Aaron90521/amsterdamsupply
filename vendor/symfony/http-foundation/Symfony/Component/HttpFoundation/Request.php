...
class Request
{
     ...
     *
     * Suppose that an index_bootstrap-TEMPLATE.php file instantiates this request object:
     *
     *  * http://localhost/index_bootstrap-TEMPLATE.php         returns an empty string
     *  * http://localhost/index_bootstrap-TEMPLATE.php/page    returns an empty string
     *  * http://localhost/web/index_bootstrap-TEMPLATE.php     returns '/web'
     *  * http://localhost/we%20b/index_bootstrap-TEMPLATE.php  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     *
     * @api
     ...
     * script filename (e.g. index_bootstrap-TEMPLATE.php) if one exists.
     *
